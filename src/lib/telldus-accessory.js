...
class TelldusDimmer extends TelldusSwitch {
   ...
   * keep track of the correct dimlevel. Some times it only sends on/off
   * commands, and it seems more correct to set the previous dimlevel than to
  ...
  /**
   * Set the state of this Accessory. This accepts a value that is either
   * true or false, for turning the dimmer off or on to previous set dimmer
   * level.
   *
   * @param  {*}                  value          The value to set,
   *                                             corresponding to the passed
